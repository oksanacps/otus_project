...
def test_search_pets_owner_in_table(driver, base_url, create_owner, cleanup_owner):
...
def test_search_pets_owner_via_search_field(driver, base_url, create_owner, cleanup_owner):
    owner_id, owner_data = create_owner
