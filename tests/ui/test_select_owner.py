...
class TestSelectOwner:
    ...
    def test_select_pets_owner_without_pets(self, driver, base_url, open_owner_information_page_without_pet, cleanup_owner):
    ...
    def test_select_pets_owner_without_visits(self, driver, base_url, open_owner_information_page_with_pet, cleanup_owner):
    ...
    @pytest.mark.nondestructive
    @allure.title("Выбор владельца питомца в таблице c назначенными питомцами")
    def test_select_pets_owner_with_pet_and_visits(self, driver, base_url, open_owner_information_page_with_pet_and_visit, cleanup_owner):
        owner_id, owner_data, data_new_pet, visit_data = open_owner_information_page_with_pet_and_visit
        owner_information_page = OwnerInformationPage(driver)
        owner_information = owner_information_page.get_owner_information()
        pet_information = owner_information_page.get_pet_information()
    ...
    def test_back_button_returns_to_owner_list_page(self, driver, base_url, open_owner_information_page_without_pet, cleanup_owner):
        owner_id, owner_data = open_owner_information_page_without_pet
